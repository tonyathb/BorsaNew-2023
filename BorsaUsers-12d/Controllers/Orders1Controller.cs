...
namespace BorsaUsers_12d.Controllers
{
    public class Orders1Controller : Controller
    {
        ...
        private readonly UserManager<Customer> _userManager; //!!! rabota s IdentityUser

        public Orders1Controller(BorsaDbContext context, UserManager<Customer> userManager)
        {
            _context = context;
