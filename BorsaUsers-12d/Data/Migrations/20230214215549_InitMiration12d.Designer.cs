...
namespace BorsaUsers_12d.Data.Migrations
{
    ...
    [Migration("20230214215549_InitMiration12d")]
    partial class InitMiration12d
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BorsaUsers_12d.Data.Customer", b =>
                {
            ...
            modelBuilder.Entity("BorsaUsers_12d.Data.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BorsaUsers_12d.Data.TypeProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BorsaUsers_12d.Data.Order", b =>
                {
                    b.HasOne("BorsaUsers_12d.Data.Customer", "Customers")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BorsaUsers_12d.Data.Product", "Products")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BorsaUsers_12d.Data.Customer", null)
                        .WithMany()
